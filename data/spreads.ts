...
export const spreads: Record<string, SpreadDefinition> = {
  ...
  'celtic-cross': {
    ...
    cardCount: 10,
    focus: '深度全景',
    suitableFor: '重大人生抉擇、自我探索、全方位分析 — 從核心議題到外在影響，完整洞悉全局',
    positions: [
      { key: '1', label: '現在', description: '目前的處境與核心問題' },
      { key: '2', label: '阻礙', description: '眼前的困難與挑戰' },
      { key: '3', label: '基礎', description: '潛意識與過去根基' },
      { key: '4', label: '過去', description: '近期事件與影響' },
      { key: '5', label: '展望', description: '最佳可能性與目標' },
      { key: '6', label: '未來', description: '近期發展方向' },
      { key: '7', label: '自我', description: '個人的態度與能量' },
      { key: '8', label: '環境', description: '外部影響與他人看法' },
      { key: '9', label: '希望/恐懼', description: '內心的渴望與擔憂' },
      { key: '10', label: '結果', description: '最終發展與總結' },
    ],
  },
}
